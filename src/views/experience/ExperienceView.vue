...
import {getTechnologies, getOtherTechnologies} from "@/data/technologies";
import InfiniteScrollComponent from "@/views/experience/components/InfiniteScrollComponent.vue";
</script>
